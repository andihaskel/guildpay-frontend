...
import { Chrome as HomeIcon, Users, ChartBar as BarChart3, CreditCard, Settings, Plus, FileText } from 'lucide-react';
    ...
    <aside className="fixed left-0 top-0 h-screen w-64 border-r border-border bg-card/50 backdrop-blur">
      ...
      <div className="p-3">
        {isLoading ? (
          ...
          <div className="w-full h-auto p-3 rounded-lg bg-accent/50">
